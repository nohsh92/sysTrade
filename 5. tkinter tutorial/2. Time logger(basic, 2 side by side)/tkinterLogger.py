...
class App:
    ...
    def __init__(self, root):
        ...
        # new second frame
        console1_frame = ttk.Labelframe(horizontal_pane, text="Console")
        console1_frame.columnconfigure(0, weight=1)
        console1_frame.rowconfigure(0, weight=1)
        horizontal_pane.add(console1_frame, weight=1)
        
        #new third frame
        console2_frame = ttk.Labelframe(horizontal_pane, text="Console")
        console2_frame.columnconfigure(0, weight=1)
        console2_frame.rowconfigure(0, weight=1)
        horizontal_pane.add(console2_frame, weight=1)
        
        
        # Original third frame
        # third_frame = ttk.Labelframe(vertical_pane, text="Third Frame")
        # vertical_pane.add(third_frame, weight=1)
        
        # Initialize all frames
        # self.form = FormUi(form_frame)
        self.console1 = ConsoleUi1(console1_frame)
        self.console2 = ConsoleUi2(console2_frame)
